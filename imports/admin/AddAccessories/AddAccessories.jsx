...
import { Accessory } from '/imports/api/Accesssory.js';
...
class AddAccessories extends Component {
    ...
    deleteAccessory = (id)=>{
        Swal({
            title: 'Are you sure?',
            text: "You won't you want to delete this",
            type: 'warning',
                                                            ...
                                                            <td className="text-center">
                                                                {
                                                                    this.props.accessoryId ? 
                                                                        ...
                                                                        :
                                                                        <div>
                                                                            <Link to={'/addAccessories/'+data._id} className="guitar-ac-btn btn btn-success mr-3">Edit</Link>
...
export default withTracker((props)=>{
    ...
    console.log('updateAccessoryData: ', updateAccessoryData);
